...
hello.utils = {
    extend: function(e) {
        for (var t = Array.prototype.slice.call(arguments, 1), n = 0; n < t.length; n++) {
            ...
            if (e instanceof Object && o instanceof Object && e !== o)
                for (var i in o)
                    e[i] = hello.utils.extend(e[i], o[i]);
            else 
                e = o
        }
        return e
    ...
    login: function() {
        var e = this.use(), t = e.utils, n = t.args({
            network: "s",
            options: "o",
            callback: "f"
        }, arguments);
        ...
        if (n.network = e.settings.default_service = n.network || e.settings.default_service, e.on("complete", n.callback), "string" != typeof n.network ||!(n.network in e.services))
            return e.emitAfter("error complete", {
                error: {
                    code: "invalid_network",
                    message: "The provided network was not recognized"
                }
            }), e;
        var a = e.services[n.network], r=!1, s = t.globalEvent(function(n) {
            var o;
        ...
        var c = t.store(n.network), u = (i.scope || "").toString();
        if (u = (u ? u + "," : "") + n.qs.scope, c && "scope"in c && c.scope instanceof String && (u += "," + c.scope), n.qs.state.scope = hello.utils.unique(u.split(/[,\s]+/)).join(","), n.qs.scope = u.replace(/[^,\s]+/gi, function(t) {
            ...
            if (0 === f.length)
                return e.emit("notice", "User already has a valid access_token"), e.emitAfter("complete success login", {
                    network: n.network,
                    authResponse: c
                }), e
        }
        if (n.qs.state.oauth = a.oauth, n.qs.state = JSON.stringify(n.qs.state), "login"in a && "function" == typeof a.login && a.login(n), 1 === parseInt(a.oauth.version, 10) ? o = t.qs(i.oauth_proxy, n.qs) : "none" === i.display && a.oauth.grant && c && c.refresh_token ? (n.qs.refresh_token = c.refresh_token, o = t.qs(i.oauth_proxy, n.qs)) : o = t.qs(a.oauth.auth, n.qs), e.emit("notice", "Authorization URL " + o), "none" === i.display)
            ...
            var d = hello.utils.popup(o, l, i.window_width || 500, i.window_height || 550), p = setInterval(function() {
        ...
        if (n.options = n.options || {}, e.on("complete", n.callback), n.name = n.name || e.settings.default_service, !n.name || n.name in e.services)
            if (n.name && t.store(n.name)) {
                ...
                if (n.options.force) {
                    ...
                    if (a)
                        if ("function" == typeof a && (a = a(o)), "string" == typeof a)
                            t.iframe(a), i.force = null, i.message = "Logout success on providers site was indeterminate";
                        else if (void 0 === a)
                            return e
                }
                o(i)
                ...
                for (var r in e.services)
                    e.services.hasOwnProperty(r) && e.logout(r);
                    e.service(!1)
            } else 
                e.emitAfter("complete error", {
                    error: {
        ...
        if ("string" == typeof e) {
            if (n = e.replace(/^[\#\?]/, "").match(/([^=\/\&]+)=([^\&]+)/g))
                for (var i = 0; i < n.length; i++)
                    t = n[i].match(/([^=]+)=(.*)/), o[t[1]] = decodeURIComponent(t[2]);
            return o
        }
        var a = e;
        o = [];
        for (var r in a)
            a.hasOwnProperty(r) && a.hasOwnProperty(r) && o.push([r, "?" === a[r] ? "?": encodeURIComponent(a[r])].join("="));
        return o.join("&")
    },
    store: function(e) {
        var t = [e, window.sessionStorage], n = 0;
        for (e = t[n++]; e;)
            try {
    ...
    args: function(e, t) {
        ...
        if (1 === t.length && "object" == typeof t[0] && "o!" != e[a])
            for (a in t[0])
                if (e.hasOwnProperty(a) && a in e)
                    return t[0];
        for (a in e)
            if (e.hasOwnProperty(a))
                if (i = typeof t[o], "function" == typeof e[a] && e[a].test(t[o]) || "string" == typeof e[a] && (e[a].indexOf("s")>-1 && "string" === i || e[a].indexOf("o")>-1 && "object" === i || e[a].indexOf("i")>-1 && "number" === i || e[a].indexOf("a")>-1 && "object" === i || e[a].indexOf("f")>-1 && "function" === i))
                    n[a] = t[o++];
                else if ("string" == typeof e[a] && e[a].indexOf("!")>-1)
                    return !1;
        return n
    },
    url: function(e) {
    ...
    unique: function(e) {
        ...
        for (var t = [], n = 0; n < e.length; n++)
            e[n] && 0 !== e[n].length&&-1 === this.indexOf(t, e[n]) && t.push(e[n]);
        return t
    },
    isEmpty: function(e) {
        if (!e)
    ...
    popup: function(e, t, n, o) {
        var i = document.documentElement, a = void 0 !== window.screenLeft ? window.screenLeft : screen.left, r = void 0 !== window.screenTop ? window.screenTop : screen.top, s = window.innerWidth || i.clientWidth || screen.width, l = window.innerHeight || i.clientHeight || screen.height, c = (s - n) / 2 + a, u = (l - o) / 2 + r, f = function(e) {
    ...
    responseHandler: function(e, t) {
        ...
        if (i = a.merge(a.param(r.search || ""), a.param(r.hash || "")), i && "state"in i) {
            ...
            if ("access_token"in i && i.access_token && i.network)
                i.expires_in && 0 !== parseInt(i.expires_in, 10) || (i.expires_in = 0), i.expires_in = parseInt(i.expires_in, 10), i.expires = (new Date).getTime() / 1e3 + (i.expires_in || 31536e3), n(i, e, t);
...
}), hello.utils.Event.call(hello), hello.subscribe = hello.on, hello.trigger = hello.emit, hello.unsubscribe = hello.off, hello.utils.responseHandler(window, window.opener || window.parent), function(e) {
    var t = {}, n = {};
    e.on("auth.login, auth.logout", function(n) {
        ...
        for (var r in e.services)
            if (e.services.hasOwnProperty(r)) {
                if (!e.services[r].id)
                    continue;
                    var s = e.utils.store(r) || {}, l = e.services[r], c = t[r] || {};
                    if (s && "callback"in s) {
                        var u = s.callback;
                        try {
                            delete s.callback
    ...
    function e(e) {
        ...
        [n.method] || n.method] || {}, d = f[e] || f["default"] || e, p = function(e) {
            ...
            if (!i.isEmpty(n.data)&&!("FileList"in window) && i.hasBinary(n.data))
    ...
    function t(e, t, n, a, r, s) {
        var l = o.services[e], c = u ? u.access_token: null, f = l.oauth && 1 === parseInt(l.oauth.version, 10) ? o.settings.oauth_proxy: null;
        if (f)
            return void s(i.qs(f, {
            path: t,
            access_token: c || "",
    ...
    var n = this.utils.args({
        ...
        timeout: "i",
        callback: "f"
    }, arguments), o = this.use(), i = o.utils;
    ...
    var c = function(t, i) {
        if (l.wrap && (n.path in l.wrap || "default"in l.wrap)) {
            var a = n.path in l.wrap ? n.path: "default", r = (new Date).getTime(), s = l.wrap[a](t, i, n);
    ...
    clone: function(e) {
        if ("nodeName"in e || this.isBinary(e))
            return e;
        var t, n = {};
        for (t in e)
            n[t] = "object" == typeof e[t] ? this.clone(e[t]) : e[t];
        return n
    },
    xhr: function(e, t, n, o, i) {
        ...
        if ("GET" === e || "DELETE" === e)
            ...
            var d = new FormData;
            for (u in o)
                o.hasOwnProperty(u) && (o[u]instanceof HTMLInputElement ? "files"in o[u] && o[u].files.length > 0 && d.append(u, o[u].files[0]) : o[u]instanceof Blob ? d.append(u, o[u], o.name) : d.append(u, o[u]));
            o = d
        }
    ...
    jsonp: function(e, t, n, o) {
        var i, a, r = this, s = 0, l = document.getElementsByTagName("head")[0], c = {
            error: {
    ...
    post: function(e, t, n, o, i, a) {
        ...
        var c, u = null, f = [], d = 0, p = null, m = 0, h = function(e) {
            m++||o(e)
        };
        r.globalEvent(h, i);
        var g;
        ...
        if (r.domInstance("form", t))
            for (u = t, d = 0; d < u.elements.length; d++)
                u.elements[d].disabled || "file" !== u.elements[d].type || (u.encoding = u.enctype = "multipart/form-data", u.elements[d].setAttribute("name", "file"));
        else {
            for (p in t)
                t.hasOwnProperty(p) && r.domInstance("input", t[p]) && "file" === t[p].type && (u = t[p].form, u.encoding = u.enctype = "multipart/form-data");
            ...
            for (p in t)
                if (t.hasOwnProperty(p)) {
                    ...
                    if (y && t[p].form === u)
                        y && t[p].name !== p && (t[p].setAttribute("name", p), t[p].name = p);
                    else {
                        var b = u.elements[p];
                        if (w)
                            for (b instanceof NodeList || (b = [b]), d = 0; d < b.length; d++)
            ...
            for (d = 0; d < u.elements.length; d++)
                w = u.elements[d], w.name in t || w.getAttribute("disabled")===!0 || (w.setAttribute("disabled", !0), f.push(w))
            }
    ...
    function e(e) {
        return function() {
            var n = e.apply(this, arguments), o = t(function(e, t) {
    ...
    e.init({
        facebook: {
            ...
            refresh: !0,
            logout: function(t) {
                var n = e.utils.globalEvent(t), o = encodeURIComponent(e.settings.redirect_uri + "?" + e.utils.param({
                    callback: n,
    ...
    function i(e) {
        s(e);
        var t = function(e) {
            var t, n = e.media$group.media$content.length ? e.media$group.media$content[0]: {}, o = 0, i = {
                id: e.id.$t,
                name: e.title.$t,
            ...
            if ("category"in e && e.category.length)
                for (t = e.category, o = 0; o < t.length; o++)
                    t[o].scheme && t[o].scheme.match(/\#kind$/) && (i.type = t[o].term.replace(/^.*?\#/, ""));
            if ("media$thumbnail"in e.media$group && e.media$group.media$thumbnail.length) {
                for (t = e.media$group.media$thumbnail, i.thumbnail = e.media$group.media$thumbnail[0].url, i.images = [], o = 0; o < t.length; o++)
                    i.images.push({
                        source: t[o].url,
                        width: t[o].width,
                        height: t[o].height
    ...
    function r(t) {
        ...
        if ("feed"in t && "entry"in t.feed) {
            for (var o = e.getAuthResponse("google").access_token, i = 0; i < t.feed.entry.length; i++) {
                var a = t.feed.entry[i], r = a.link && a.link.length > 0 ? a.link[0].href + "?access_token=" + o: null;
                n.push({
                    id: a.id.$t,
                    name: a.title.$t,
    ...
    function s(e) {
        if ("feed"in e && e.feed.openSearch$itemsPerPage) {
            var t = n(e.feed.openSearch$itemsPerPage.$t), o = n(e.feed.openSearch$startIndex.$t), i = n(e.feed.openSearch$totalResults.$t);
            i > o + t && (e.paging = {
                next: "?start=" + (o + t)
            })
        } else 
    ...
    function l() {
        ...
        var o = [], i = (1e10 * Math.random()).toString(32), a = 0, r = "\r\n", s = r + "--" + i, l = function() {}, c = /^data\:([^;,]+(\;charset=[^;,]+)?)(\;base64)?,/i;
        this.append = function(o, i) {
            "string" != typeof o && "length"in Object(o) || (o = [o]);
            for (var s = 0; s < o.length; s++) {
                a++;
                var l = o[s];
                if (l instanceof t.File || l instanceof t.Blob)
                    e(l);
    ...
    function c(e, n, o, i, a) {
        ...
        var s = function() {
            var s = t.navigator, l=++v, c = p.param(n.match(/\?.+/)[0]), u = c.access_token;
    ...
    var m, h, g, v, w = [], y = "https://www.google.com/m8/feeds/contacts/default/full?alt=json&max-results=@{limit|1000}&start-index=@{start|1}";
    e.init({
        google: {
            name: "Google Plus",
            login: function(e) {
            ...
            api: function(e, t, n, o) {
                if ("get" !== t.method) {
                    ...
                    var i;
                    if ("file"in t.data && (i = t.data.file, delete t.data.file, "object" == typeof i && "files"in i && (i = i.files), !i ||!i.length))
                        return void o({
                        error: {
                            code: "request_invalid",
        ...
        if (e.query && e.query.results && e.query.results.contact) {
            ...
            for (var a = 0; a < e.data.length; a++) {
                ...
                for (var r = 0; r < n.fields.length; r++)
                    i = n.fields[r], "email" === i.type && (n.email = i.value), "name" === i.type && (n.first_name = i.value.givenName, n.last_name = i.value.familyName, n.name = i.value.givenName + " " + i.value.familyName), "yahooid" === i.type && (n.id = i.value)
                }
        }
        return e
    }
    ...
    e.init({
        yahoo: {
            ...
            wrap: {
                me: function(e) {
                    return t(e), e.query && e.query.results && e.query.results.profile && (e = e.query.results.profile, e.id = e.guid, e.name = e.givenName + " " + e.familyName, e.last_name = e.familyName, e.first_name = e.givenName, e.email = e.emails ? e.emails.handle : null, e.thumbnail = e.image ? e.image.imageUrl : null), e
                },
                "me/friends": n,
                "me/following": n,
                "default": function(e) {
